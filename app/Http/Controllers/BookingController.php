...
class BookingController extends Controller
{
     ...
     * @return mixed
     */
    public function index(Request $request, $user_id = null) // Route based filtering
    {
        if(!is_null($user_id)) {
     ...
     * @return mixed
     */
    public function getHistory(Request $request, $user_id = null) // Route based filtering
    {
        if(!is_null($user_id)) {
